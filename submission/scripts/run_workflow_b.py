#!/usr/bin/env python3
"""One-command launcher for Workflow B (underwriting and pricing decision
...
Usage:
    ...
    python submission/scripts/run_workflow_b.py --fixture evaluation/fixtures/EV-06/fixture.json --out out.json
...
from workflow_b.engine import build_response  # noqa: E402

EXPECTED_WORKFLOW = "underwriting_pricing_support"


def main() -> int:
    parser = argparse.ArgumentParser(description="Run Workflow B against one fixture.")
