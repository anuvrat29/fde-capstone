#!/usr/bin/env python3
"""One-command launcher for Workflow A (coverage/claim/fraud evidence
reconciliation), per submission/runbooks/RUN.md.

Usage:
    python submission/scripts/run_workflow_a.py --fixture evaluation/fixtures/EV-01/fixture.json
    python submission/scripts/run_workflow_a.py --fixture evaluation/fixtures/EV-01/fixture.json --out out.json
...
from workflow_a.engine import build_response  # noqa: E402

EXPECTED_WORKFLOW = "coverage_claim_reconciliation"


def main() -> int:
    parser = argparse.ArgumentParser(description="Run Workflow A against one fixture.")
